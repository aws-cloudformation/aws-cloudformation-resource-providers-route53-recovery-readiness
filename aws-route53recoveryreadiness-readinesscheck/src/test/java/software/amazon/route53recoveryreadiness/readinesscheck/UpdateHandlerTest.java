...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ResourceModel previousModel = ResourceModel.builder()
                .readinessCheckName("MyReadinessCheck")
                .resourceSetName("SomeResourceSet")
                .readinessCheckArn("ReadinessCheckArn")
                .build();
        ...
        final UpdateReadinessCheckResponse updateResponse = UpdateReadinessCheckResponse.builder()
                .readinessCheckName("MyReadinessCheck")
                .resourceSet("MyResourceSet")
                .readinessCheckArn("myReadinessCheckArn")
                .build();

        final GetReadinessCheckResponse getPreviousModelResponse = GetReadinessCheckResponse.builder()
                .readinessCheckName("MyReadinessCheck")
                .resourceSet("SomeResourceSet")
                .readinessCheckArn("myReadinessCheckArn")
                .build();
        ...
        doReturn(getPreviousModelResponse)
