...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final DeleteResourceSetResponse deleteResponse = DeleteResourceSetResponse.builder().build();

        final GetResourceSetResponse getResponse = GetResourceSetResponse.builder().resourceSetName(model.getResourceSetName()).build();
