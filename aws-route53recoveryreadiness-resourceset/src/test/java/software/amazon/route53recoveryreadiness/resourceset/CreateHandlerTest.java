...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final List<software.amazon.route53recoveryreadiness.resourceset.Resource> resources = new ArrayList<>();

        final List<software.amazon.awssdk.services.route53recoveryreadiness.model.Resource> returnedResources = new ArrayList<>();
        ...
        final CreateResourceSetResponse createResponse = CreateResourceSetResponse.builder()
                .resourceSetName("MyResourceSet1")
                .resourceSetArn("resourceArn2")
                .resources(returnedResources)
                .build();
        ...
        assertThat(response.getResourceModel().getResourceSetArn()).isNotNull();
        assertThat(response.getResourceModel().getResources().size()).isEqualTo(0);
